...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <a class="navbar-brand" href="{{route('LoginProcess')}}">Neotech Vagas</a>
  ...
  @if(Auth()->check())
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="modal" data-bs-target="#config" onclick="edit();" href="#"><img src="image/icons/icons8-nome-24.png">{{auth()->user()->name}}
